...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Lato', sans-serif; }
        body, html { height: 100%; background-color: #f4f7f6; }
        ...
        .sidebar-header img { width: 50px; margin-right: 15px; }
        .sidebar-header .logo-text { display: flex; flex-direction: column; }
        .sidebar-header .logo-text span:first-child { font-weight: 700; font-size: 1.1rem; }
        .sidebar-header .logo-text span:last-child { font-size: 0.9rem; color: #bdc3c7; }
        ...
        .sidebar-nav li a {
            ...
            color: #ecf0f1; text-decoration: none; font-size: 1rem;
        ...
        .sidebar-nav li a.active {
            background-color: #1e4a9c; font-weight: 700;
            border-left: 5px solid #3498db; padding-left: 20px;
        }
        .sidebar-nav li a:hover:not(.active) { background-color: #1a4a9c; }
        ...
        /* --- Topbar --- */
        .topbar {
            width: 100%; background-color: #ffffff; border-bottom: 1px solid #ddd;
            padding: 20px 30px; display: flex; justify-content: flex-end; align-items: center;
        }
        ...
        .user-info-trigger {
            ...
            cursor: pointer; padding: 5px; border-radius: 8px; transition: background-color 0.2s;
        }
        ...
        .dropdown-menu {
            ...
            border: 1px solid #ddd; z-index: 50; min-width: 200px; display: none;
        }
        .dropdown-menu[x-show] { display: block; }
        .dropdown-menu a {
            display: block; padding: 12px 20px; text-decoration: none;
            color: #333; font-size: 1rem; transition: background-color 0.2s;
        }
        ...
        /* --- Konten --- */
        .content-area { flex-grow: 1; padding: 30px; background-color: #f4f7f6; }
        .content-title { font-size: 1.8rem; font-weight: 700; color: #333; margin-bottom: 20px; }
        .content-box {
